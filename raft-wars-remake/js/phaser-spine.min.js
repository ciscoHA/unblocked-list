...
spine.Bone.prototype = {
    ...
    updateWorldTransform: function(a, b, c, d, e) {
        ...
        var n = l.a
          ...
          , p = l.c
          , q = l.d;
        if (this.worldX = n * a + o * b + l.worldX,
...
spine.Slot.prototype = {
    ...
    setAttachment: function(a) {
        this.attachment != a && (this.attachment = a,
...
spine.IkConstraint = function(a, b) {
    ...
    for (var c = 0, d = a.bones.length; c < d; c++)
        this.bones[c] = b.findBone(a.bones[c].name);
...
spine.IkConstraint.apply2 = function(a, b, c, d, e, f) {
    if (0 != f) {
        var g, h, i, j = a.x, k = a.y, l = a.appliedScaleX, m = a.appliedScaleY;
        l < 0 ? (l = -l,
        g = 180,
        i = -1) : (g = 0,
        i = 1),
        ...
        var n = b.x
          ...
          , p = b.appliedScaleX
          , q = Math.abs(l - m) <= 1e-4;
        q || 0 == o || (b.worldX = a.a * n + a.worldX,
        b.worldY = a.c * n + a.worldY,
        o = 0),
        p < 0 ? (p = -p,
        h = 180) : h = 0;
        ...
        if (v) {
            ...
            t = b.worldX - j,
            u = b.worldY - k;
        var F, G, H = Math.sqrt(t * t + u * u), I = b.data.length * p;
        a: if (q) {
            I *= l;
            ...
            ba = D,
            ca = E),
            P <= (Y + aa) / 2 ? (F = L - Math.atan2($ * e, Z),
            G = X * e) : (F = L - Math.atan2(ca * e, ba),
            G = _ * e)
        }
...
spine.Animation.prototype = {
    apply: function(a, b, c, d, e) {
        ...
        b > 0 && (b %= this.duration));
        for (var f = this.timelines, g = 0, h = f.length; g < h; g++)
            f[g].apply(a, b, c, e, 1)
    },
    mix: function(a, b, c, d, e, f) {
        d && 0 != this.duration && (c %= this.duration,
        b > 0 && (b %= this.duration));
        for (var g = this.timelines, h = 0, i = g.length; h < i; h++)
            g[h].apply(a, b, c, e, f)
    }
},
...
spine.Curves.prototype = {
    ...
    setCurve: function(a, b, c, d, e) {
        var f = .1
          ...
          , x = this.curves;
        x[w++] = 2;
        for (var y = q, z = r, A = w + 19 - 1; w < A; w += 2)
            x[w] = y,
            x[w + 1] = z,
            q += s,
            r += t,
...
spine.RotateTimeline.prototype = {
    ...
    apply: function(a, b, c, d, e) {
        ...
        if (!(c < f[0])) {
            ...
            if (c >= f[f.length - 2]) {
                for (var h = g.data.rotation + f[f.length - 1] - g.rotation; h > 180; )
                    h -= 360;
                for (; h < -180; )
                    h += 360;
            ...
            for (var h = f[i + 1] - j; h > 180; )
                h -= 360;
            for (; h < -180; )
                h += 360;
            for (h = g.data.rotation + (j + h * l) - g.rotation; h > 180; )
                h -= 360;
            for (; h < -180; )
                h += 360;
            g.rotation += h * e
...
spine.TranslateTimeline.prototype = {
    ...
    apply: function(a, b, c, d, e) {
        ...
        if (!(c < f[0])) {
            var g = a.bones[this.boneIndex];
            if (c >= f[f.length - 3])
                return g.x += (g.data.x + f[f.length - 2] - g.x) * e,
...
spine.ScaleTimeline.prototype = {
    ...
    apply: function(a, b, c, d, e) {
        ...
        if (!(c < f[0])) {
            var g = a.bones[this.boneIndex];
            if (c >= f[f.length - 3])
                return g.scaleX += (g.data.scaleX * f[f.length - 2] - g.scaleX) * e,
...
spine.AttachmentTimeline.prototype = {
    ...
    apply: function(a, b, c, d, e) {
        var f = this.frames;
        if (c < f[0])
            return void (b > c && this.apply(a, b, Number.MAX_VALUE, null, 0));
        b > c && (b = -1);
    ...
    apply: function(a, b, c, d, e) {
        if (d) {
            var f = this.frames
              , g = f.length;
            if (b > c)
                this.apply(a, b, Number.MAX_VALUE, d, e),
                b = -1;
            else if (b >= f[g - 1])
                return;
            if (!(c < f[0])) {
                ...
                if (b < f[0])
                    ...
                    for (var i = f[h]; h > 0 && f[h - 1] == i; )
                        h--
                }
                for (var j = this.events; h < g && c >= f[h]; h++)
                    d[d.length] = j[h]
            }
        }
    }
    ...
    apply: function(a, b, c, d, e) {
        ...
        if (g && (g == this.attachment || g.inheritFFD && g.parentMesh == this.attachment)) {
            ...
            if (!(c < h[0])) {
                ...
                if (k.length != j && (f.attachmentVertices = k = new spine.Float32Array(j),
                e = 1),
                c >= h[h.length - 1]) {
                    var l = i[h.length - 1];
                    if (e < 1)
...
spine.IkConstraintTimeline.prototype = {
    ...
    apply: function(a, b, c, d, e) {
        ...
        if (!(c < f[0])) {
            ...
            if (c >= f[f.length - 3])
                return g.mix += (f[f.length - 2] - g.mix) * e,
...
spine.Skeleton = function(a) {
    ...
    this.ikConstraints = [];
    for (var b = 0, c = a.ikConstraints.length; b < c; b++)
        this.ikConstraints[b] = new spine.IkConstraint(a.ikConstraints[b],this);
    this.transformConstraints = [];
    for (var b = 0, c = a.transformConstraints.length; b < c; b++)
        this.transformConstraints[b] = new spine.TransformConstraint(a.transformConstraints[b],this);
    this.cache = [],
    this.updateCache()
}
,
spine.Skeleton.prototype = {
    ...
    updateWorldTransform: function() {
        for (var a = this.cache, b = 0, c = a.length; b < c; b++)
            a[b].update()
    },
    setToSetupPose: function() {
    ...
    setSlotsToSetupPose: function() {
        for (var a = this.slots, b = this.drawOrder, c = 0, d = a.length; c < d; c++)
            b[c] = a[c],
...
spine.MeshAttachment.prototype = {
    ...
    updateUVs: function() {
        ...
        if (this.uvs && this.uvs.length == c || (this.uvs = new spine.Float32Array(c)),
        this.regionRotate)
            for (var d = 0; d < c; d += 2)
                this.uvs[d] = this.regionU + this.regionUVs[d + 1] * a,
                this.uvs[d + 1] = this.regionV + b - this.regionUVs[d] * b;
        else
            for (var d = 0; d < c; d += 2)
                this.uvs[d] = this.regionU + this.regionUVs[d] * a,
...
spine.WeightedMeshAttachment.prototype = {
    ...
    updateUVs: function(a, b, c, d, e) {
        ...
        if (this.uvs && this.uvs.length == h || (this.uvs = new spine.Float32Array(h)),
        this.regionRotate)
            for (var i = 0; i < h; i += 2)
                this.uvs[i] = this.regionU + this.regionUVs[i + 1] * f,
                this.uvs[i + 1] = this.regionV + g - this.regionUVs[i] * g;
        else
            for (var i = 0; i < h; i += 2)
                this.uvs[i] = this.regionU + this.regionUVs[i] * f,
...
spine.AnimationState.prototype = {
    ...
    setCurrent: function(a, b) {
        ...
        if (c) {
            ...
            d && c.mixTime / c.mixDuration < .5 ? b.previous = d : b.previous = c)
        }
        this.tracks[a] = b,
...
spine.SkeletonJson.prototype = {
    ...
    readSkeletonData: function(a, b) {
        ...
        if (k)
            for (var f = 0, g = k.length; f < g; f++) {
                for (var l = k[f], m = new spine.IkConstraintData(l.name), e = l.bones, n = 0, o = e.length; n < o; n++) {
                    ...
                    if (!p)
                        throw "IK bone not found: " + e[n];
                    m.bones[n] = p
                }
                if (m.target = c.findBone(l.target),
                !m.target)
                    throw "Target bone not found: " + l.target;
        ...
        if (q)
            for (var f = 0, g = q.length; f < g; f++) {
                ...
                if (s.bone = c.findBone(r.bone),
                !s.bone)
                    throw "Bone not found: " + r.bone;
                if (s.target = c.findBone(r.target),
                !s.target)
                    throw "Target bone not found: " + r.target;
        ...
        for (var t = a.slots, f = 0, g = t.length; f < g; f++) {
            ...
            var v = new spine.SlotData(u.name,j)
              , w = u.color;
            w && (v.r = this.toColor(w, 0),
            v.g = this.toColor(w, 1),
            v.b = this.toColor(w, 2),
            v.a = this.toColor(w, 3)),
        ...
        for (var f = 0, g = this.linkedMeshes.length; f < g; f++) {
            ...
            if (!A)
                throw "Skin not found: " + G.skin;
            var i = A.getAttachment(G.slotIndex, G.parent);
            if (!i)
                throw "Parent mesh not found: " + G.parent;
        ...
        var L = a.animations;
        for (var M in L)
            L.hasOwnProperty(M) && this.readAnimation(M, L[M], c);
        return c
    },
    readAttachment: function(a, b, c, d) {
        ...
        case spine.AttachmentType.linkedmesh:
            ...
            d.parent ? (j.inheritFFD = !d.hasOwnProperty("ffd") || d.ffd,
        ...
        case spine.AttachmentType.weightedlinkedmesh:
            ...
            j.height = (d.height || 0) * g,
            d.parent)
                j.inheritFFD = !d.hasOwnProperty("ffd") || d.ffd,
                this.linkedMeshes[this.linkedMeshes.length] = {
                    mesh: j,
                    skin: d.skin,
                    slotIndex: b,
                ...
                for (var j in h)
                    if (h.hasOwnProperty(j)) {
                        ...
                        if ("color" == j) {
                            ...
                            if ("attachment" != j)
                                throw "Invalid timeline type for a slot: " + j + " (" + g + ")";
                ...
                for (var j in y)
                    if (y.hasOwnProperty(j)) {
                        ...
                        if ("rotate" == j) {
                            ...
                            if ("translate" != j && "scale" != j)
                                throw "Invalid timeline type for a bone: " + j + " (" + w + ")";
                            var l, z = 1;
                            "scale" == j ? l = new spine.ScaleTimeline(k.length) : (l = new spine.TranslateTimeline(k.length),
                            z = this.scale),
                            l.boneIndex = x;
                            for (var m = 0, n = 0, o = k.length; n < o; n++) {
                                var p = k[n]
        ...
        for (var I in H) {
            ...
            for (g in h) {
                ...
                for (var L in K) {
                    ...
                    if (!M)
                        throw "FFD attachment not found: " + L;
                    l.slotIndex = i,
                    l.attachment = M;
                    ...
                    for (var m = 0, n = 0, o = k.length; n < o; n++) {
                        ...
                        if (p.vertices) {
                            ...
                            if (1 == this.scale)
                                ...
                                for (var T = 0; T < S; T++)
                                    P[T + R] = Q[T] * this.scale;
                            if (O)
                                for (var U = M.vertices, T = 0, S = P.length; T < S; T++)
                                    P[T] += U[T]
                        } else
                            O ? P = M.vertices : (P = new spine.Float32Array(N),
                            P.length = N);
    ...
    getUint32Array: function(a, b) {
        for (var c = a[b], d = new spine.Uint32Array(c.length), e = 0, f = c.length; e < f; e++)
            d[e] = 0 | c[e];
        return d
    },
    getUint16Array: function(a, b) {
        for (var c = a[b], d = new spine.Uint16Array(c.length), e = 0, f = c.length; e < f; e++)
            d[e] = 0 | c[e];
        return d
    }
},
    ...
    for (var e = null; ; ) {
        ...
        f.length)
            if (e) {
                ...
                g.u = h / e.width,
                g.v = i / e.height,
                g.rotate ? (g.u2 = (h + k) / e.width,
                g.v2 = (i + j) / e.height) : (g.u2 = (h + j) / e.width,
                g.v2 = (i + k) / e.height),
                g.x = h,
                g.y = i,
                g.width = Math.abs(j),
                g.height = Math.abs(k),
                4 == c.readTuple(d) && (g.splits = [parseInt(d[0]), parseInt(d[1]), parseInt(d[2]), parseInt(d[3])],
                4 == c.readTuple(d) && (g.pads = [parseInt(d[0]), parseInt(d[1]), parseInt(d[2]), parseInt(d[3])],
                c.readTuple(d))),
                ...
                e.name = f,
                2 == c.readTuple(d) && (e.width = parseInt(d[0]),
                e.height = parseInt(d[1]),
                c.readTuple(d)),
...
spine.Atlas.prototype = {
    ...
    dispose: function() {
        for (var a = this.pages, b = 0, c = a.length; b < c; b++)
...
spine.AtlasAttachmentLoader.prototype = {
    newRegionAttachment: function(a, b, c) {
        ...
        if (!d)
            throw "Region not found in atlas: " + c + " (region attachment: " + b + ")";
    ...
    newMeshAttachment: function(a, b, c) {
        var d = this.atlas.findRegion(c);
        if (!d)
            throw "Region not found in atlas: " + c + " (mesh attachment: " + b + ")";
    ...
    newWeightedMeshAttachment: function(a, b, c) {
        var d = this.atlas.findRegion(c);
        if (!d)
            throw "Region not found in atlas: " + c + " (weighted mesh attachment: " + b + ")";
...
spine.SkeletonBounds.prototype = {
    ...
    update: function(a, b) {
        ...
        for (var j = 0; j < d; j++) {
            ...
            if (m.type == spine.AttachmentType.boundingbox) {
                ...
                var n, o = h.length;
                o > 0 ? (n = h[o - 1],
                h.splice(o - 1, 1)) : n = new spine.Float32Array,
                i[i.length] = n,
    ...
    aabbIntersectsSegment: function(a, b, c, d) {
        var e = this.minX
          ...
          , g = this.maxX
          , h = this.maxY;
        if (a <= e && c <= e || b <= f && d <= f || a >= g && c >= g || b >= h && d >= h)
            return !1;
        var i = (d - b) / (c - a)
          , j = i * (e - a) + b;
        if (j > f && j < h)
    ...
    polygonIntersectsSegment: function(a, b, c, d, e) {
        for (var f = a.length, g = b - d, h = c - e, i = b * e - c * d, j = a[f - 2], k = a[f - 1], l = 0; l < f; l += 2) {
            ...
            if ((s >= j && s <= m || s >= m && s <= j) && (s >= b && s <= d || s >= d && s <= b)) {
                var t = (i * q - h * o) / r;
                if ((t >= k && t <= n || t >= n && t <= k) && (t >= c && t <= e || t >= e && t <= c))
                    return !0
            }
            j = m,
            k = n
...
!function(a) {
    var b = function(b) {
        function c(c, d, e) {
            ...
            if (f.skeletonData = k.readSkeletonData(c.cache.getJSON(d)),
            !f.skeletonData)
            ...
            for (var l = 0, m = f.skeleton.slots.length; l < m; l++) {
                ...
                o instanceof spine.RegionAttachment) {
                    ...
                    if (!(o instanceof spine.WeightedMeshAttachment))
                        continue;
        ...
        c.prototype.update = function(a) {
            if (void 0 !== a) {
                ...
                for (var b = this.skeleton.drawOrder, c = this.skeleton.slots, d = 0, e = b.length; d < e; d++)
                    void 0 !== b[d].currentSprite && (this.children[d] = b[d].currentSprite.parent);
                    ...
                    if (g) {
                        ...
                        if (i === spine.AttachmentType.region) {
                            ...
                            if (!f.currentMeshName || f.currentMeshName !== g.name) {
                                var m = g.name;
                                if (void 0 !== f.currentMesh && (f.currentMesh.visible = !1),
                                f.meshes = f.meshes || {},
                                void 0 !== f.meshes[m])
                                    f.meshes[m].visible = !0;
                                else {
        ...
        c.prototype.createSprite = function(a, b) {
            ...
            if (g.scale.x = c.width / c.originalWidth * b.scaleX / this.imageScale,
            g.scale.y = c.height / c.originalHeight * b.scaleY / this.imageScale,
            g.rotation = h,
            g.anchor.x = (.5 * c.originalWidth - c.offsetX) / c.width,
            g.anchor.y = 1 - (.5 * c.originalHeight - c.offsetY) / c.height,
            g.alpha = b.a,
            c.rotate) {
                var i = g.scale.x;
                g.scale.x = g.scale.y,
